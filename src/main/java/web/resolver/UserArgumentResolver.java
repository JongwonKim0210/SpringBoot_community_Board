...
import web.domain.enums.SocialType;
...
import static web.domain.enums.SocialType.*;
    ...
    private User getUser(User user, HttpSession session){
        if(user == null){
            try {
                ...
                User convertUser = convertUser(String.valueOf(authentication.getAuthorizedClientRegistrationId()), map);
